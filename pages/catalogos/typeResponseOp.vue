            ...
            <div class="level-right">
              <p class="level-item">
                <b-button type="is-primary" outlined @click="isActive = true">
                  Nuevo tipo de respuesta (para opiniones técnicas)
                </b-button>
              </p>
            </div>
          </nav>
                    ...
                    <div class="level-left">
                      <div class="level-item">
                        <p class="card-header-title">
                          ID: {{ vegetation.idapplication_method }}
                        </p>
                      </div>
                    </div>
    ...
    async saveEdit () {
      try {
        ...
        await this.$store.dispatch(
          'modules/responseOp/createOrUpdateResponseOp',
          this.vegetation
        )
        this.vegetation = {}
        this.selectVeg = false
    ...
    deleteVeg (vegetation) {
      this.$swal({
        ...
        if (result.isConfirmed) {
          try {
            await this.$store.dispatch(
              'modules/responseOp/deleteResponseOp',
              vegetation
            )
            this.getData()
            this.vegetation = {}
