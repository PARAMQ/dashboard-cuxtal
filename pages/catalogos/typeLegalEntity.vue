                    ...
                    <div class="level-left">
                      <div class="level-item">
                        <p class="card-header-title">
                          ID: {{ vegetation.idtype_legal_entity }}
                        </p>
                      </div>
                    </div>
    ...
    async saveEdit () {
      try {
        ...
        await this.$store.dispatch(
          'modules/legalEntity/createOrUpdateTypeLegalEntity',
          this.vegetation
        )
        this.vegetation = {}
        this.selectVeg = false
    ...
    deleteVeg (vegetation) {
      this.$swal({
        ...
        if (result.isConfirmed) {
          try {
            await this.$store.dispatch(
              'modules/legalEntity/deleteTypeLegalEntity',
              vegetation
            )
            this.getData()
            this.vegetation = {}
