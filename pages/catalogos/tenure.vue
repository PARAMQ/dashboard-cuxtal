                        ...
                        <div class="container">
                          <div class="columns">
                            <div class="column has-text-centered">
                              <p>
                                <b-icon icon="home-variant" custom-size="default" />
                                {{ veg.description }}
                              </p>
                            </div>
                          </div>
    ...
    async saveEdit () {
      try {
        ...
        await this.$store.dispatch(
          'modules/tenure/createOrUpdateTenure',
          this.vegetation
        )
        this.vegetation = {}
        this.selectVeg = false
