...
import nuxt_plugin_plugin_15927dd7 from 'nuxt_plugin_plugin_15927dd7' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_workbox_8fca7d6e from 'nuxt_plugin_workbox_8fca7d6e' // Source: ./workbox.js (mode: 'client')
import nuxt_plugin_metaplugin_c2b2a148 from 'nuxt_plugin_metaplugin_c2b2a148' // Source: ./pwa/meta.plugin.js (mode: 'all')
import nuxt_plugin_iconplugin_b9635660 from 'nuxt_plugin_iconplugin_b9635660' // Source: ./pwa/icon.plugin.js (mode: 'all')
import nuxt_plugin_axios_f24d1926 from 'nuxt_plugin_axios_f24d1926' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_buefy_48b872be from 'nuxt_plugin_buefy_48b872be' // Source: ./buefy.js (mode: 'all')
import nuxt_plugin_nuxtleaflet_41a0d8b8 from 'nuxt_plugin_nuxtleaflet_41a0d8b8' // Source: ./nuxt-leaflet.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_15927dd7 === 'function') {
    await nuxt_plugin_plugin_15927dd7(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_8fca7d6e === 'function') {
    await nuxt_plugin_workbox_8fca7d6e(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_c2b2a148 === 'function') {
    await nuxt_plugin_metaplugin_c2b2a148(app.context, inject)
  }

  if (typeof nuxt_plugin_iconplugin_b9635660 === 'function') {
    await nuxt_plugin_iconplugin_b9635660(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_f24d1926 === 'function') {
    await nuxt_plugin_axios_f24d1926(app.context, inject)
  }

  if (typeof nuxt_plugin_buefy_48b872be === 'function') {
    await nuxt_plugin_buefy_48b872be(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_nuxtleaflet_41a0d8b8 === 'function') {
    await nuxt_plugin_nuxtleaflet_41a0d8b8(app.context, inject)
  }
