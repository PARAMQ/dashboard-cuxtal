...
(function (global, factory) {
  ...
  const globIsFinite = glob.isFinite || noop$1;
  ...
  function plainProps(object) {
    ...
    const isPlain = x => isNumeric$1(x) || isString(x) || isArray$2(x) || isBoolean(x) || isPlainObject(x);
  ...
  function filter$1(collection) {
    let iteratee = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : negate(isEmpty$2);
  ...
  function find(collection) {
    let iteratee = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity$2;
    const res = filter$1(collection, iteratee);
  ...
  function omit(object, key) {
    ...
    return filter$1(object, (value, key) => !keys.includes(key));
  }
  ...
  function difference(array1, array2) {
    let comparator = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : isEqual;
    return filter$1(array1, value => !includes$1(array2, value, comparator));
  }
  /**
   * @param {string} str
   * @return {string}
  ...
  function instanceOf(value, Ctor, msg) {
    assert$1(value instanceof Ctor, msg || `value is an instance of ${Ctor.name}`);
  }
  ...
  function mergeDescriptors() {
    ...
    return args.slice(1).reduce((dest, src, i) => mergeDescriptors$1(dest, src, redefine), args[0]);
  }
  ...
  ***************************************************************************** */
  ...
  class WaitCancelError extends Error {
    constructor(message) {
      ...
      _defineProperty$1(this, "name", 'WaitCancelError');
  ...
  class WaitTimeoutError extends Error {
    constructor(message) {
      ...
      _defineProperty$1(this, "name", 'WaitTimeoutError');
  ...
  function waitFor(condition, breakOn, timeout$1) {
    ...
    const success = interval(1000 / 60).pipe(isFunction$1(condition) ? skipWhile(negate(condition)) : skipUntil(condition.pipe(skipWhile(defCond))), first());
    let failed = NEVER;

    if (breakOn) {
      failed = interval(1000 / 60).pipe(isFunction$1(breakOn) ? skipWhile(negate(breakOn)) : skipUntil(breakOn.pipe(skipWhile(defCond))), first(), switchMap(() => throwError(new WaitCancelError('wait canceled'))));
    }
  ...
  const isPointCoords = /*#__PURE__*/and(isArray$2, point => point.length >= 2, point => every(point, isNumber$1));
  const isLineCoords = /*#__PURE__*/and(isArray$2, line => line.length >= 0, line => every(line, isPointCoords));
  const isPolygonCoords = /*#__PURE__*/and(isArray$2, polygon => polygon.length >= 0, polygon => every(polygon, isLineCoords));
  const isMultiPointCoords = isLineCoords;
  const isMultiLineCoords = isPolygonCoords;
  const isMultiPolygonCoords = /*#__PURE__*/and(isArray$2, multiPolygon => multiPolygon.length >= 0, multiPolygon => every(multiPolygon, isPolygonCoords));
  ...
  function toSimpleGeom(geom$1) {
    ...
    const type = geom$1.type || geom$1.getType();
  ...
  function transform(coordinate, sourceProjection, destProjection) {
    let precision = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : COORD_PRECISION;
    if (!coordinate) return;
    let coord = proj.transform(coordinate, sourceProjection, destProjection);
  ...
  function transformExtent$1(extent, sourceProjection, destProjection) {
    ...
    let ext = proj.transformExtent(extent, sourceProjection, destProjection);
  ...
  function createStyle(vlStyle) {
    let geomReader = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity$2;
  ...
  function dumpStyle(olStyle) {
    let geomWriter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity$2;
    ...
    switch (true) {
      case imageStyle instanceof style$1.Icon:
        return { ...common,
          ...
          [prefixKey('color')]: isArray$2(imageStyle.getColor()) ? imageStyle.getColor().slice() : imageStyle.getColor(),
          [prefixKey('offset')]: imageStyle.offset_.slice(),
          [prefixKey('offsetOrigin')]: imageStyle.offsetOrigin_,
          [prefixKey('size')]: isArray$2(imageStyle.getSize()) ? imageStyle.getSize().slice() : imageStyle.getSize(),
  ...
  class GeoJSON extends format.GeoJSON {
    constructor() {
      let options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      super(options);
      this.defaultDecimals = options.decimals != null && options.decimals > -1 ? options.decimals : undefined;
      this.defaultStyleReader = options.styleReader || noop$1;
      this.defaultStyleWriter = options.styleWriter || noop$1;
    }
    ...
    writeGeometryObject(geometry, options) {
      ...
      if (isCircleGeom(geometry)) {
        ...
        const radius = sphere.getLength(new geom.LineString([center, end]), options.featureProjection);
    ...
    writeFeatureObject(feature, options) {
      ...
      if (!isEmpty$1(properties)) {
        ...
        if (isArray$2(properties.features)) {
          object.properties.features = map$1(properties.features, feature => {
    ...
    readFeatureFromObject(object, options) {
      ...
      if (geoJSONFeature.properties) {
        ...
        if (isArray$2(geoJSONFeature.properties.features)) {
          geoJSONFeature.properties.features = map$1(geoJSONFeature.properties.features, feature => {
  ...
  function isGeoJSONGeometry(geometry) {
    return isPlainObject(geometry) && Object.values(GeometryType).includes(geometry.type) && geometry.geometries ? geometry.geometries.every(geometry => isArray$2(geometry.coordinates)) : isArray$2(geometry === null || geometry === void 0 ? void 0 : geometry.coordinates);
  }
  ...
  function extentFromProjection(projection) {
    ...
    if (!extent) {
      const half = 180 * METERS_PER_UNIT[Units$1.DEGREES] / projection.getMetersPerUnit();
  ...
  function initEventBus() {
    ...
    if (!hasProp(Vue__default["default"], EVENT_BUS_PROP)) {
      Object.defineProperties(Vue__default["default"], {
        [EVENT_BUS_PROP]: {
          enumerable: true,
          get: () => bus
        }
    ...
    if (!hasProp(Vue__default["default"].prototype, EVENT_BUS_PROP)) {
      Object.defineProperties(Vue__default["default"].prototype, {
        [EVENT_BUS_PROP]: {
          enumerable: true,
          get: () => bus
        }
  ...
  var rxSubs = {
    ...
    methods: {
      ...
      subscribeTo(observable) {
        let next = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : noop$1;
        let error = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : noop$1;
        let complete = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : noop$1;
  ...
  class LifecycleError extends Error {
    constructor(err, vmName, action) {
      ...
      _defineProperty$1(this, "name", 'LifecycleError');
  ...
  class CanceledError extends Error {
    constructor(message) {
      ...
      _defineProperty$1(this, "name", 'CanceledError');
  ...
  class OLObjectNotInitializedError extends Error {
    constructor(message) {
      ...
      _defineProperty$1(this, "name", 'OLObjectNotInitializedError');
  ...
  var baseLayer = {
    ...
    props: {
      ...
      extent: {
        type: Array,
        validator: value => value.length === 4 && value.every(isNumber$1)
      },
      ...
      extentProjection: {
        type: String,
        validator: value => !!proj.get(value)
      },
  ...
  async function subscribeToLayerEvents$4() {
    const setterKey = addPrefix('set');
  ...
  var controlsContainer = {
    ...
    created() {
       ...
       * @private
       */
      this._controlsCollection = this.instanceFactoryCall(this.controlsCollectionIdent, () => new ol.Collection());
      this._controlSubs = {};
  ...
  async function subscribeToEvents$2() {
  ...
  var featuresContainer = {
    ...
    created() {
       ...
       * @private
       */
      this._featuresCollection = this.instanceFactoryCall(this.featuresCollectionIdent, () => new ol.Collection());
      this._featureSubs = {};
    ...
    methods: {
      ...
      getClosestFeatureToCoordinate(coordinate) {
        let filter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : identity$2;
        let viewProj = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  ...
  const validateAttributions = /*#__PURE__*/or(isString, isFunction$1, value => isArray$2(value) && value.every(isString));
  /**
   * Base source mixin.
   */
  ...
  async function subscribeToSourceEvents$3() {
  ...
  var interactionsContainer = {
    ...
    created() {
       ...
       * @private
       */
      this._interactionsCollection = this.instanceFactoryCall(this.interactionsCollectionIdent, () => new ol.Collection());
  ...
  var layersContainer = {
    ...
    created() {
       ...
       * @private
       */
      this._layersCollection = this.instanceFactoryCall(this.layersCollectionIdent, () => new ol.Collection());
      this._layerSubs = {};
  ...
  var overlaysContainer = {
    ...
    created() {
       ...
       * @private
       */
      this._overlaysCollection = this.instanceFactoryCall(this.overlaysCollectionIdent, () => new ol.Collection());
      this._overlaySubs = {};
  ...
  const isNotEmptyString$1 = /*#__PURE__*/and(isString, negate(isEmpty$2));
  const isArrayOfNotEmptyStrings = /*#__PURE__*/and(isArray$2, value => value.every(isNotEmptyString$1));
  var urlTileSource = {
    mixins: [tileSource],
    props: {
      // ol/source/UrlTile
    ...
    computed: {
      ...
      inputUrls() {
        return this.parsedUrls.reduce((urls, url) => urls.concat(...expandUrl$1(url)), []);
      },
  ...
  const isNotEmptyString = /*#__PURE__*/and(isString, negate(isEmpty$2));
  /**
  ...
  var vectorSource = {
    ...
    props: {
      ...
      url: {
        ...
        validator: value => isFunction$1(value) || isNotEmptyString(value)
      },
    ...
    methods: {
      ...
      removeFeatureInternal(feature) {
        ...
        const featureKey = util.getUid(feature);
  ...
  */
  ...
  const validateTileSize$1 = /*#__PURE__*/or(isNumber$1, and(isArray$2, value => value.length === 2 && value.every(isNumber$1)));
  /**
  ...
  var script$P = {
    ...
    methods: {
      ...
      async createInteraction() {
        ...
        assert$1(!!source, `Source "${this.source}" not found in identity map.`);
        let features;
        ...
        if (!(source instanceof source$1.Vector)) {
          ...
          instanceOf(features, ol.Collection, `Source "${this.source}" doesn't provide features collection.`);
          source = null;
        }

        return new interaction$1.Draw({
          source,
          features,
  ...
  //
  const validateProjection = /*#__PURE__*/and(isString, value => proj.get(value) != null);
  var script$G = {
    name: 'VlGeoloc',
  ...
  const validateUrl$1 = /*#__PURE__*/and(isString, negate(isEmpty$2));
  var script$r = {
  ...
  const validateUrl = /*#__PURE__*/and(isString, negate(isEmpty$2));
  var script$o = {
  ...
  var script$l = {
    ...
    props: {
      ...
      center: {
        type: Array,
        default: () => [0, 0],
        validator: value => value.length === 2 && value.every(isNumber$1)
      },
      ...
      resolutions: {
        type: Array,
        validator: value => value.every(isNumber$1)
      },
      ...
      projection: {
        type: String,
        default: EPSG_3857,
        validator: value => proj.get(value) != null
      },
    ...
    methods: {
      ...
      async fit(geometryOrExtent) {
        ...
        } else if (isFunction$1(geometryOrExtent.resolveOlObject)) {
          geometryOrExtent = await geometryOrExtent.resolveOlObject();
        }

        const cb = options.callback || noop$1;
        const view = await this.resolveView();
        return new Promise(resolve => {
  ...
  var script$h = {
    ...
    props: {
      ...
      layerIds: {
        type: Array,
        validate: val => isArray$2(val) && val.every(isString)
      },
  ...
  var script$g = {
    ...
    methods: {
      ...
      async createInteraction() {
        ...
        return new interaction$1.Modify({
          source,
          features,
          condition: this.condition,
  ...
  */
  ...
  var script$c = {
    ...
    props: {
      ...
      features: {
        type: Array,
        default: stubArray,
        validator: value => value.every(or(isString, isNumber$1, isGeoJSONFeature))
      },
    ...
    methods: {
      ...
      resolveFeature(feature) {
        ...
        const featureId = isString(feature) || isNumber$1(feature) ? feature : getFeatureId(feature);
  ...
  var script$4 = {
    ...
    methods: {
      ...
      async createInteraction() {
        ...
        return new interaction$1.Translate({
          features,
  ...
  const validateTileSize = /*#__PURE__*/or(isNumber$1, and(isArray$2, value => value.length === 2 && value.every(isNumber$1)));
  var script$2 = {
  ...
  var script$1 = {
    ...
    props: {
      ...
      matrixIds: {
        type: Array,
        validator: value => value.every(or(isNumber$1, isString))
      },
      maxZoom: {
        type: Number,
  ...
  function resolutionsFromExtent(extent$1, maxZoom, tileSize, maxResolution) {
    ...
    const height = extent.getHeight(extent$1);
    const width = extent.getWidth(extent$1);
